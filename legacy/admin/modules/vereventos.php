    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="../view/img/carousel-eventos/<?php echo $eventos['imagen']; ?>">Imagen</a></td>
                <td id="row-status<?php echo $eventos['id']; ?>"><input class="js-toggle-status" data-id="<?php echo $eventos['id'];?>" data-section="2" type="checkbox" <?php echo ($eventos['activo'] == '1') ? 'checked' :''; ?> data-toggle="toggle" data-on="Activo" data-off="Inactivo" data-onstyle="success" data-offstyle="danger"></span></td>
                <td><button id="button-delete<?php echo $eventos['id']; ?>" class="btn btn-default" data-toggle="modal" data-target="#panel-delete-modal" data-id="<?php echo $eventos['id'];?>" data-section="2">Borrar</button></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
